...
function addEvent() {
    ...
    // Check if date and title are provided
    if (date && title) {
...
function displayReminders() {
    ...
    // Loop through events and display reminders for the current month
...
// Generate the year range and set it as the HTML content of the year select input
...
// HTML content for the table head
$dataHead = "<tr>";
for (dhead in days) {
...
// Set the HTML content of the table head
document.getElementById("thead-month").innerHTML = $dataHead;

// Get references to the month and year elements in the HTML
